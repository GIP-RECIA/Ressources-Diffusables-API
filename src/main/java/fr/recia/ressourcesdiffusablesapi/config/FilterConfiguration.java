...
public class FilterConfiguration {
    ...
    public FilterConfiguration(ICacheService cacheService) {
        this.cacheService = cacheService;
    }


    @Bean
    public IRessourceDiffusableFilterService filterService() {
        return new RessourceDiffusableFilterServiceDefaultImpl(cacheService);
    }
}
